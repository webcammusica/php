...
if (!isset($_GET['id'])) {
  ...
  $resultado['mensaje'] = 'Parámetro \'id\' no enviado. Revisa que la url sea algo como 
  "https://webcammusica.000webhostapp.com/ejercicios_PHP/CRUDphp/editar.php?id=1": ';
}
...
if (isset($_POST['submit'])) {
  try {
    ...
    $consultaSQL = "UPDATE alumnos SET nombre = :nombre, apellido = :apellido, email = :email, edad = :edad, updated_at = NOW() WHERE id = :id";
